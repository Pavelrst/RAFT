...
from core.utils.scopeflow_utils import flowlib
from core.utils.scopeflow_utils.resize_utils import resize_tensor
from core.utils.scopeflow_utils.image_utils import rgb2gray, warp_image, torchify
...
def show_image(im, subplote=False, overlay=False, ax=True):
    ...
    # if im.max() > 1.:
    # some values are slightly bigger than 1.
    if im.max() > 1.1:
        im = im / 255.
